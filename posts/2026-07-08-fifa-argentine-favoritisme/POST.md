...
Source : article fourni par Thomas, adapté au gabarit 10 slides une·deux (le contenu factuel, y compris les nuances « prouvé / non prouvé », est repris tel qu'écrit dans l'article d'origine).
...
**CTA (slide 10)** — série `arretdejeu`, template `cta`
...
Les slides intérieures (02→09) sont dans `script.json` (format `post.html`, templates A/H/G).
...
## Structure narrative (10 slides)

| # | Template | Fonction | Contenu |
|---|----------|----------|---------|
| S1 | A | HOOK | La question posée cash + boucle « la même phrase revient » |
| S2 | A | CONSTAT | 1978 — le 6-0 et la dérogation d'horaire FIFA |
| S3 | H | respiration | « Le score interroge. Le calendrier, encore plus. » |
| S4 | A | ENQUÊTE | L'hypothèse opération Condor (non prouvée, présentée comme telle) |
| S5 | G | citation réelle | Fernández Moores, journaliste |
| S6 | A | ENQUÊTE | 2022 — les six penaltys + la phrase d'Infantino sur Messi |
| S7 | G | citation réelle | Pepe, après l'élimination du Portugal |
| S8 | A | ENQUÊTE | 2026 — tirage au sort déplacé + classement FIFA qui change 4 fois |
| S9 | A | PISTE (climax) | La leçon transposable : pas un complot, un biais qui protège les stars |
| S10 | D | ACTION | CTA ouvert, ne referme pas la question |

---

## Prompts photo (L'arrêt de jeu — rouille investigative, `nano_banana_pro`, 4:5)

Slides illustrées : S1, S2, S4, S6, S8, S9 (pas les H ni G).
...
**argentine_06.PNG (LA PISTE — climax)**
```
...
| 4 changements de leader au classement FIFA (déc. 2025 → juil. 2026) | ✅ présenté comme fait acquis (S8) |
| Levée de la suspension de Balogun après un appel de Trump à Infantino | ✅ présenté comme fait acquis (S9) |
| Conclusion « biais qui protège les stars » | 🧭 présentée comme piste/hypothèse, pas comme un verdict (S9), conforme à la posture éditoriale de la série |
