...
/**
 * Ported verbatim from design-system/components/slides/CTASlide.jsx (canvas templates "D"/"S").
 */
export function CTASlide({
  ...
  return (
    ...
    >
      ...
      <div style={{marginTop: '2.2cqw', fontFamily: 'var(--font-body)', fontSize: '3.7cqw', maxWidth: '86%'}}>{body}</div>

      <div style={{flex: 1}} />
      <div style={{alignSelf: 'stretch', height: 3, background: 'var(--ink)', marginBottom: '2.8cqw'}} />
      <div style={{alignSelf: 'flex-start', fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: '2.96cqw'}}>@UNE.DEUX</div>
    </div>
  );
}
